...
fn register_all_then_update() -> Result<()> {
    ...
    assert_eq!(names, vec!["cpu", "percpu", "processcount", "processlist", "programlist", "ip", "mem", "memswap", "load", "uptime", "now", "system", "fs", "diskio", "folders", "raid", "network", "connections", "ports", "containers", "cloud", "amps", "smart", "vms", "sensors", "gpu", "npu", "wifi", "mpp", "alert", "quicklook", "help", "version", "psutilversion"]);
    Ok(())
}
