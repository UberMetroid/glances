...
fn register_all_then_update() -> Result<()> {
    ...
    assert_eq!(names, vec!["cpu", "percpu", "irq", "processcount", "ip", "mem", "memswap", "load", "uptime", "now", "system", "fs", "diskio", "folders", "raid", "network", "connections", "ports", "containers", "cloud", "amps", "sensors", "gpu", "npu", "wifi", "mpp", "alert", "quicklook", "help", "version", "psutilversion"]);
    Ok(())
}
